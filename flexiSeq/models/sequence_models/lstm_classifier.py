...
class LSTMClassifier(BaseClassifier):
    def __init__(self,
        ...
        """
        LSTM classifier for variable-length sequences.

        Args:
            input_size (int): Number of input features.
            hidden_size (int, optional): Number of hidden units in the LSTM. Defaults to 256.
    ...
    def _build_model(self) -> nn.Module:
        ...
        return LSTMNet(self.input_size, self.hidden_size, self.num_classes)
    ...
    def fit(self,
        ...
        Args:
            ...
            val_loader (DataLoader, optional): DataLoader for the validation data. If None, the training data is used.
        ...
        for epoch in epoch_iterator:
            ...
            # Evaluate on validation set if provided; otherwise, fallback to training data.
    ...
    def evaluate(self,
        ...
        if verbose:
            print(f"[LSTMClassifier] Evaluation -- Accuracy: {accuracy:.4f}, AUC: {auc:.4f}, F1: {f1:.4f} F1 (weighted): {f1_weighted:.4f}")
